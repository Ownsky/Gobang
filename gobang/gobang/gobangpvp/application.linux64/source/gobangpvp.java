...
public class gobangpvp extends PApplet {
...
public int checkrd(int x, int y) {
  int t = 1;
  int posX = x;
  int posY = y;
...
public int checkld(int x, int y) {
  int t = 1;
  int posX = x;
  int posY = y;
  ...
  public void settings() {  size(800, 620);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "gobangpvp" };
    if (passedArgs != null) {
